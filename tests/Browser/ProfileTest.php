...
it('notifies the original email if updated', function () {
    ...
    Notification::assertSentOnDemand(EmailChanged::class, function (EmailChanged $notification, $routes, $notifiable) use ($origionalEmail) {
        return $notifiable->routes['mail'] === $origionalEmail;
    });
